...
function update_ip_notification_fields()
{
  var selected = $('#organization_ip_notification_method_id')
...
$(document).ready(function(){
  ...
  update_ip_notification_fields();

  $('#organization_ip_notification_method_id').change( function() {
    update_ip_notification_fields();
  });
});
