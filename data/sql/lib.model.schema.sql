...
(
	...
	`start_ip_int` INTEGER UNSIGNED  NOT NULL,
	`end_ip` VARCHAR(15),
	`end_ip_int` INTEGER UNSIGNED,
...
(
	...
	`web_admin_uri` VARCHAR(255),
	`web_admin_username` VARCHAR(50),
	`web_admin_password` VARCHAR(50),
	`web_contact_form_uri` VARCHAR(255),
