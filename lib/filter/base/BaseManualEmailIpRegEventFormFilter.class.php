...
/**
 * ManualEmailIpRegEvent filter form base class.
 *
 * @package    freerms
 * @subpackage filter
 * @author     Your name here
 */
abstract class BaseManualEmailIpRegEventFormFilter extends BaseFormFilterPropel
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('manual_email_ip_reg_event_filters[%s]');
