...
abstract class BaseIpRange extends BaseObject  implements Persistent {
  ...
  const PEER = 'IpRangePeer';
	...
	public function setActiveIndicator($v)
	{
		...
		if ($this->active_indicator !== $v || $v === true) {
	...
	public function setProxyIndicator($v)
	{
		...
		if ($this->proxy_indicator !== $v || $v === false) {
	...
	public function hasOnlyDefaultValues()
	{
			...
			if (array_diff($this->modifiedColumns, array(IpRangePeer::ACTIVE_INDICATOR,IpRangePeer::PROXY_INDICATOR))) {
				return false;
			}
