...
abstract class BaseIpRange extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the start_ip_int field.
	 * @var        string
	 */
	protected $start_ip_int;
	...
	/**
	 * The value for the end_ip_int field.
	 * @var        string
	 */
	protected $end_ip_int;
	...
	/**
	 * Get the [start_ip_int] column value.
	 * 
	 * @return     string
	 */
	public function getStartIpInt()
	{
		return $this->start_ip_int;
	}
	...
	/**
	 * Get the [end_ip_int] column value.
	 * 
	 * @return     string
	 */
	public function getEndIpInt()
	{
		return $this->end_ip_int;
	}
	...
	/**
	 * Set the value of [start_ip_int] column.
	 * 
	 * @param      string $v new value
	 * @return     IpRange The current object (for fluent API support)
	 */
	...
	/**
	 * Set the value of [end_ip_int] column.
	 * 
	 * @param      string $v new value
	 * @return     IpRange The current object (for fluent API support)
	 */
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->start_ip_int = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			$this->end_ip = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
			$this->end_ip_int = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
			$this->active_indicator = ($row[$startcol + 6] !== null) ? (boolean) $row[$startcol + 6] : null;
			$this->proxy_indicator = ($row[$startcol + 7] !== null) ? (boolean) $row[$startcol + 7] : null;
			...
			return $startcol + 11; // 11 = IpRangePeer::NUM_COLUMNS - IpRangePeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			...
			case 2:
				...
				break;
			case 3:
				return $this->getStartIpInt();
				break;
			case 4:
				return $this->getEndIp();
				break;
			case 5:
				return $this->getEndIpInt();
				break;
			case 6:
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[3] => $this->getStartIpInt(),
			$keys[4] => $this->getEndIp(),
			$keys[5] => $this->getEndIpInt(),
			$keys[6] => $this->getActiveIndicator(),
			$keys[7] => $this->getProxyIndicator(),
			$keys[8] => $this->getNote(),
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			...
			case 2:
				...
				break;
			case 3:
				$this->setStartIpInt($value);
				break;
			case 4:
				$this->setEndIp($value);
				break;
			case 5:
				$this->setEndIpInt($value);
				break;
			case 6:
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[3], $arr)) $this->setStartIpInt($arr[$keys[3]]);
		if (array_key_exists($keys[4], $arr)) $this->setEndIp($arr[$keys[4]]);
		if (array_key_exists($keys[5], $arr)) $this->setEndIpInt($arr[$keys[5]]);
		if (array_key_exists($keys[6], $arr)) $this->setActiveIndicator($arr[$keys[6]]);
		if (array_key_exists($keys[7], $arr)) $this->setProxyIndicator($arr[$keys[7]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(IpRangePeer::START_IP_INT)) $criteria->add(IpRangePeer::START_IP_INT, $this->start_ip_int);
		if ($this->isColumnModified(IpRangePeer::END_IP)) $criteria->add(IpRangePeer::END_IP, $this->end_ip);
		if ($this->isColumnModified(IpRangePeer::END_IP_INT)) $criteria->add(IpRangePeer::END_IP_INT, $this->end_ip_int);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setStartIpInt($this->start_ip_int);

		$copyObj->setEndIp($this->end_ip);

		$copyObj->setEndIpInt($this->end_ip_int);
	 ...
	 * related IpRegEvents from storage. If this IpRange is new, it will return
		...
		if ($this->collIpRegEvents === null) {
			if ($this->isNew()) {
			   $this->collIpRegEvents = array();
				...
				$criteria->add(IpRegEventPeer::IP_RANGE_ID, $this->id);
	 ...
	 */
	public function getIpRegEventsJoinAcquisition($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(IpRangePeer::DATABASE_NAME);
		}
		...
		if ($this->collIpRegEvents === null) {
			if ($this->isNew()) {
				...
				$this->collIpRegEvents = IpRegEventPeer::doSelectJoinAcquisition($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
