...
abstract class BaseIpRegEvent extends BaseObject  implements Persistent {
	...
	/**
	 * Initializes internal state of BaseIpRegEvent object.
	 * @see        applyDefaults()
	 */
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = IpRegEventPeer::ID;
		}
	...
	public function setAcqId($v)
	{
		...
		if ($this->acq_id !== $v) {
			$this->acq_id = $v;
			$this->modifiedColumns[] = IpRegEventPeer::ACQ_ID;
		}
	...
	public function setProcessed($v)
	{
		...
		if ($this->processed !== $v || $this->isNew()) {
			$this->processed = $v;
			$this->modifiedColumns[] = IpRegEventPeer::PROCESSED;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->ip_range_id = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
			$this->acq_id = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
			$this->old_start_ip = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
			$this->old_end_ip = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
			$this->new_start_ip = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
			$this->new_end_ip = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
			$this->processed = ($row[$startcol + 7] !== null) ? (boolean) $row[$startcol + 7] : null;
			...
			return $startcol + 9; // 9 = IpRegEventPeer::NUM_COLUMNS - IpRegEventPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getIpRangeId(),
			$keys[2] => $this->getAcqId(),
			$keys[3] => $this->getOldStartIp(),
			$keys[4] => $this->getOldEndIp(),
			$keys[5] => $this->getNewStartIp(),
			$keys[6] => $this->getNewEndIp(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[1], $arr)) $this->setIpRangeId($arr[$keys[1]]);
		if (array_key_exists($keys[2], $arr)) $this->setAcqId($arr[$keys[2]]);
		if (array_key_exists($keys[3], $arr)) $this->setOldStartIp($arr[$keys[3]]);
		if (array_key_exists($keys[4], $arr)) $this->setOldEndIp($arr[$keys[4]]);
		if (array_key_exists($keys[5], $arr)) $this->setNewStartIp($arr[$keys[5]]);
		if (array_key_exists($keys[6], $arr)) $this->setNewEndIp($arr[$keys[6]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(IpRegEventPeer::ID)) $criteria->add(IpRegEventPeer::ID, $this->id);
		if ($this->isColumnModified(IpRegEventPeer::IP_RANGE_ID)) $criteria->add(IpRegEventPeer::IP_RANGE_ID, $this->ip_range_id);
		if ($this->isColumnModified(IpRegEventPeer::ACQ_ID)) $criteria->add(IpRegEventPeer::ACQ_ID, $this->acq_id);
		...
		if ($this->isColumnModified(IpRegEventPeer::PROCESSED)) $criteria->add(IpRegEventPeer::PROCESSED, $this->processed);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(IpRegEventPeer::ID, $this->id);
	...
	public function getIpRange(PropelPDO $con = null)
	{
		if ($this->aIpRange === null && ($this->ip_range_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aIpRange->addIpRegEvents($this);
			 */
		}
	...
	public function getAcquisition(PropelPDO $con = null)
	{
		if ($this->aAcquisition === null && ($this->acq_id !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aAcquisition->addIpRegEvents($this);
			 */
		}
