...
abstract class BaseEResource extends BaseObject  implements Persistent {
  ...
  const PEER = 'EResourcePeer';
	...
	public function setProductUnavailable($v)
	{
		...
		if ($this->product_unavailable !== $v || $v === false) {
	...
	public function hasOnlyDefaultValues()
	{
			...
			if (array_diff($this->modifiedColumns, array(EResourcePeer::LANGUAGE,EResourcePeer::SUPPRESSION,EResourcePeer::PRODUCT_UNAVAILABLE))) {
				return false;
			}
    ...
    if ($this->isNew() && !$this->isColumnModified(EResourcePeer::CREATED_AT))
    {
	...
	public function getAccessInfo(PropelPDO $con = null)
	{
		if ($this->aAccessInfo === null && ($this->access_info_id !== null)) {
			$c = new Criteria(AccessInfoPeer::DATABASE_NAME);
			$c->add(AccessInfoPeer::ID, $this->access_info_id);
			$this->aAccessInfo = AccessInfoPeer::doSelectOne($c, $con);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
	...
	public function getAdminInfo(PropelPDO $con = null)
	{
		if ($this->aAdminInfo === null && ($this->admin_info_id !== null)) {
			$c = new Criteria(AdminInfoPeer::DATABASE_NAME);
			$c->add(AdminInfoPeer::ID, $this->admin_info_id);
			$this->aAdminInfo = AdminInfoPeer::doSelectOne($c, $con);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
