...
abstract class BaseOrganization extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the web_admin_uri field.
	 * @var        string
	 */
	protected $web_admin_uri;

	/**
	 * The value for the web_admin_username field.
	 * @var        string
	 */
	protected $web_admin_username;

	/**
	 * The value for the web_admin_password field.
	 * @var        string
	 */
	protected $web_admin_password;

	/**
	 * The value for the web_contact_form_uri field.
	 * @var        string
	 */
	protected $web_contact_form_uri;
	...
	/**
	 * Get the [web_admin_uri] column value.
	 * 
	 * @return     string
	 */
	public function getWebAdminUri()
	{
		return $this->web_admin_uri;
	}

	/**
	 * Get the [web_admin_username] column value.
	 * 
	 * @return     string
	 */
	public function getWebAdminUsername()
	{
		return $this->web_admin_username;
	}

	/**
	 * Get the [web_admin_password] column value.
	 * 
	 * @return     string
	 */
	public function getWebAdminPassword()
	{
		return $this->web_admin_password;
	}

	/**
	 * Get the [web_contact_form_uri] column value.
	 * 
	 * @return     string
	 */
	public function getWebContactFormUri()
	{
		return $this->web_contact_form_uri;
	}
	...
	/**
	 * Set the value of [web_admin_uri] column.
	 * 
	 * @param      string $v new value
	 * @return     Organization The current object (for fluent API support)
	 */
	public function setWebAdminUri($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->web_admin_uri !== $v) {
			$this->web_admin_uri = $v;
			$this->modifiedColumns[] = OrganizationPeer::WEB_ADMIN_URI;
		}
	...
	/**
	 * Set the value of [web_admin_username] column.
	 * 
	 * @param      string $v new value
	 * @return     Organization The current object (for fluent API support)
	 */
	public function setWebAdminUsername($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->web_admin_username !== $v) {
			$this->web_admin_username = $v;
			$this->modifiedColumns[] = OrganizationPeer::WEB_ADMIN_USERNAME;
		}
	...
	/**
	 * Set the value of [web_admin_password] column.
	 * 
	 * @param      string $v new value
	 * @return     Organization The current object (for fluent API support)
	 */
	public function setWebAdminPassword($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->web_admin_password !== $v) {
			$this->web_admin_password = $v;
			$this->modifiedColumns[] = OrganizationPeer::WEB_ADMIN_PASSWORD;
		}
	...
	/**
	 * Set the value of [web_contact_form_uri] column.
	 * 
	 * @param      string $v new value
	 * @return     Organization The current object (for fluent API support)
	 */
	public function setWebContactFormUri($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->web_contact_form_uri !== $v) {
			$this->web_contact_form_uri = $v;
			$this->modifiedColumns[] = OrganizationPeer::WEB_CONTACT_FORM_URI;
		}

		return $this;
	} // setWebContactFormUri()
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->web_admin_uri = ($row[$startcol + 8] !== null) ? (string) $row[$startcol + 8] : null;
			$this->web_admin_username = ($row[$startcol + 9] !== null) ? (string) $row[$startcol + 9] : null;
			$this->web_admin_password = ($row[$startcol + 10] !== null) ? (string) $row[$startcol + 10] : null;
	...
	public function getByPosition($pos)
	{
		switch($pos) {
			...
			case 7:
				...
				break;
			case 8:
				return $this->getWebAdminUri();
				break;
			case 9:
				return $this->getWebAdminUsername();
				break;
			case 10:
				return $this->getWebAdminPassword();
				break;
			case 11:
				return $this->getWebContactFormUri();
				break;
			case 12:
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[8] => $this->getWebAdminUri(),
			$keys[9] => $this->getWebAdminUsername(),
			$keys[10] => $this->getWebAdminPassword(),
	...
	public function setByPosition($pos, $value)
	{
		switch($pos) {
			...
			case 7:
				...
				break;
			case 8:
				$this->setWebAdminUri($value);
				break;
			case 9:
				$this->setWebAdminUsername($value);
				break;
			case 10:
				$this->setWebAdminPassword($value);
				break;
			case 11:
				$this->setWebContactFormUri($value);
				break;
			case 12:
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[8], $arr)) $this->setWebAdminUri($arr[$keys[8]]);
		if (array_key_exists($keys[9], $arr)) $this->setWebAdminUsername($arr[$keys[9]]);
		if (array_key_exists($keys[10], $arr)) $this->setWebAdminPassword($arr[$keys[10]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(OrganizationPeer::WEB_ADMIN_URI)) $criteria->add(OrganizationPeer::WEB_ADMIN_URI, $this->web_admin_uri);
		if ($this->isColumnModified(OrganizationPeer::WEB_ADMIN_USERNAME)) $criteria->add(OrganizationPeer::WEB_ADMIN_USERNAME, $this->web_admin_username);
		if ($this->isColumnModified(OrganizationPeer::WEB_ADMIN_PASSWORD)) $criteria->add(OrganizationPeer::WEB_ADMIN_PASSWORD, $this->web_admin_password);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setWebAdminUri($this->web_admin_uri);

		$copyObj->setWebAdminUsername($this->web_admin_username);

		$copyObj->setWebAdminPassword($this->web_admin_password);

		$copyObj->setWebContactFormUri($this->web_contact_form_uri);
