...
abstract class BaseLibraryPeer {
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new LibraryMapBuilder();
		}
    ...
    foreach (sfMixer::getCallables('BaseLibraryPeer:doCount:doCount') as $callable)
    {
      call_user_func($callable, 'BaseLibraryPeer', $criteria, $con);
    }
    ...
    foreach (sfMixer::getCallables('BaseLibraryPeer:doSelectStmt:doSelectStmt') as $callable)
    {
      call_user_func($callable, 'BaseLibraryPeer', $criteria, $con);
    }
  ...
  static public function getUniqueColumnNames()
  {
	...
	{
		return LibraryPeer::CLASS_DEFAULT;
	}
    ...
    foreach (sfMixer::getCallables('BaseLibraryPeer:doInsert:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BaseLibraryPeer', $values, $con);
      if (false !== $ret)
      {
        return $ret;
      }
    ...
    foreach (sfMixer::getCallables('BaseLibraryPeer:doInsert:post') as $callable)
    {
      call_user_func($callable, 'BaseLibraryPeer', $values, $con, $pk);
    }
    ...
    foreach (sfMixer::getCallables('BaseLibraryPeer:doUpdate:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BaseLibraryPeer', $values, $con);
      if (false !== $ret)
      {
    ...
    foreach (sfMixer::getCallables('BaseLibraryPeer:doUpdate:post') as $callable)
    {
      call_user_func($callable, 'BaseLibraryPeer', $values, $con, $ret);
    }
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		} elseif ($values instanceof Library) {
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			$c->add(AcqLibAssocPeer::LIB_ID, $obj->getId());
			$affectedRows += AcqLibAssocPeer::doDelete($c, $con);

			// delete related IpRange objects
			$c = new Criteria(IpRangePeer::DATABASE_NAME);
			
			$c->add(IpRangePeer::LIB_ID, $obj->getId());
			$affectedRows += IpRangePeer::doDelete($c, $con);
		}
		return $affectedRows;
	}
	...
	public static function doValidate(Library $obj, $cols = null)
	{
		...
		$res =  BasePeer::doValidate(LibraryPeer::DATABASE_NAME, LibraryPeer::TABLE_NAME, $columns);
    if ($res !== true) {
        $request = sfContext::getInstance()->getRequest();
        foreach ($res as $failed) {
            $col = LibraryPeer::translateFieldname($failed->getColumn(), BasePeer::TYPE_COLNAME, BasePeer::TYPE_PHPNAME);
        }
    }
...
//
// NOTE: This static code cannot call methods on the LibraryPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the LibraryPeer class:
//
// Propel::getDatabaseMap(LibraryPeer::DATABASE_NAME)->addTableBuilder(LibraryPeer::TABLE_NAME, LibraryPeer::getMapBuilder());
//
// Doing so will effectively overwrite the registration below.

Propel::getDatabaseMap(BaseLibraryPeer::DATABASE_NAME)->addTableBuilder(BaseLibraryPeer::TABLE_NAME, BaseLibraryPeer::getMapBuilder());
