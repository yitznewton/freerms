...
/**
 * This class defines the structure of the 'auto_email_ip_reg_events' table.
 *
 *
 ...
 */
class AutoEmailIpRegEventTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.AutoEmailIpRegEventTableMap';
	...
	{
	  // attributes
		$this->setName('auto_email_ip_reg_events');
		$this->setPhpName('AutoEmailIpRegEvent');
		$this->setClassname('AutoEmailIpRegEvent');
