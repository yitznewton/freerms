...
class AccessInfoTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addColumn('ONSITE_ACCESS_HANDLER', 'OnsiteAccessHandler', 'VARCHAR', false, 255, null);
		$this->addColumn('OFFSITE_ACCESS_HANDLER', 'OffsiteAccessHandler', 'VARCHAR', false, 255, null);
