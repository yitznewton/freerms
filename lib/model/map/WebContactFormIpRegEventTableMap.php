...
/**
 * This class defines the structure of the 'web_contact_form_ip_reg_events' table.
 *
 *
 * This class was autogenerated by Propel 1.4.1 on:
 *
 * Mon May 17 17:27:45 2010
 *
 *
 ...
 */
class WebContactFormIpRegEventTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.WebContactFormIpRegEventTableMap';
	...
	{
	  // attributes
		$this->setName('web_contact_form_ip_reg_events');
		$this->setPhpName('WebContactFormIpRegEvent');
		$this->setClassname('WebContactFormIpRegEvent');
...
} // WebContactFormIpRegEventTableMap
