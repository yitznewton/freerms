...
/**
 * This class defines the structure of the 'phone_ip_reg_events' table.
 *
 *
 ...
 */
class PhoneIpRegEventTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'lib.model.map.PhoneIpRegEventTableMap';
	...
	{
	  // attributes
		$this->setName('phone_ip_reg_events');
		$this->setPhpName('PhoneIpRegEvent');
		$this->setClassname('PhoneIpRegEvent');
