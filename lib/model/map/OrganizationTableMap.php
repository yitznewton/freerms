...
class OrganizationTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addColumn('WEB_ADMIN_URI', 'WebAdminUri', 'VARCHAR', false, 255, null);
		$this->addColumn('WEB_ADMIN_USERNAME', 'WebAdminUsername', 'VARCHAR', false, 50, null);
		$this->addColumn('WEB_ADMIN_PASSWORD', 'WebAdminPassword', 'VARCHAR', false, 50, null);
    ...
    $this->addRelation('Contact', 'Contact', RelationMap::ONE_TO_MANY, array('id' => 'org_id', ), 'CASCADE', 'CASCADE');
	} // buildRelations()
