...
class ContactTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addForeignKey('ORG_ID', 'OrgId', 'INTEGER', 'organizations', 'ID', true, null, null);
	...
	{
    $this->addRelation('Organization', 'Organization', RelationMap::MANY_TO_ONE, array('org_id' => 'id', ), 'CASCADE', 'CASCADE');
