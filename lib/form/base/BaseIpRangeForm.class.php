...
abstract class BaseIpRangeForm extends BaseFormPropel
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'start_ip_int'     => new sfValidatorInteger(array('min' => -9.22337203685E+18, 'max' => 9223372036854775807)),
      'end_ip'           => new sfValidatorString(array('max_length' => 15, 'required' => false)),
      'end_ip_int'       => new sfValidatorInteger(array('min' => -9.22337203685E+18, 'max' => 9223372036854775807, 'required' => false)),
