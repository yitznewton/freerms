...
abstract class BaseAccessInfoForm extends BaseFormPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'onsite_access_handler'  => new sfWidgetFormInputText(),
      'offsite_access_handler' => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'onsite_access_handler'  => new sfValidatorString(array('max_length' => 255, 'required' => false)),
      'offsite_access_handler' => new sfValidatorString(array('max_length' => 255, 'required' => false)),
