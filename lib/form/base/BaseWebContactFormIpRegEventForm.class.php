...
/**
 * WebContactFormIpRegEvent form base class.
 *
 * @method WebContactFormIpRegEvent getObject() Returns the current form's model object
 *
 * @package    freerms
 * @subpackage form
 * @author     Your name here
 */
abstract class BaseWebContactFormIpRegEventForm extends BaseFormPropel
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('web_contact_form_ip_reg_event[%s]');
  ...
  {
    return 'WebContactFormIpRegEvent';
  }
